...
std::list<std::tuple<std::string,char,std::bitset<6>,std::bitset<11>,std::string,std::string>> ISA = {
    ...
    {"lb", IMMEDIATE, std::bitset<6>("100000"), std::bitset<11>(IMMEDIATE_OP), LOAD_IMMEDIATE, LOAD_IMMEDIATE_FORMAT},
    {"lh", IMMEDIATE, std::bitset<6>("100001"), std::bitset<11>(IMMEDIATE_OP), LOAD_IMMEDIATE, LOAD_IMMEDIATE_FORMAT},
    {"sb", IMMEDIATE, std::bitset<6>("101000"), std::bitset<11>(IMMEDIATE_OP), STORE_IMMEDIATE, STORE_IMMEDIATE_FORMAT},
    {"sh", IMMEDIATE, std::bitset<6>("101001"), std::bitset<11>(IMMEDIATE_OP), STORE_IMMEDIATE, STORE_IMMEDIATE_FORMAT},
    {"bge", IMMEDIATE, std::bitset<6>("101100"), std::bitset<11>(IMMEDIATE_OP), GENERIC_IMMEDIATE, GENERIC_IMMEDIATE_FORMAT},
    {"bgt", IMMEDIATE, std::bitset<6>("101110"), std::bitset<11>(IMMEDIATE_OP), GENERIC_IMMEDIATE, GENERIC_IMMEDIATE_FORMAT},
    {"blt", IMMEDIATE, std::bitset<6>("110000"), std::bitset<11>(IMMEDIATE_OP), GENERIC_IMMEDIATE, GENERIC_IMMEDIATE_FORMAT},
    {"ble", IMMEDIATE, std::bitset<6>("110010"), std::bitset<11>(IMMEDIATE_OP), GENERIC_IMMEDIATE, GENERIC_IMMEDIATE_FORMAT},
    {"nop", IMMEDIATE, std::bitset<6>("010101"), std::bitset<11>(IMMEDIATE_OP), NOP_IMMEDIATE, NOP_IMMEDIATE_FORMAT},

    {"addui", UIMMEDIATE, std::bitset<6>("001001"), std::bitset<11>(UIMMEDIATE_OP), GENERIC_UIMMEDIATE, GENERIC_UIMMEDIATE_FORMAT},
    {"subui", UIMMEDIATE, std::bitset<6>("001011"), std::bitset<11>(UIMMEDIATE_OP), GENERIC_UIMMEDIATE, GENERIC_UIMMEDIATE_FORMAT},
    {"lbu", UIMMEDIATE, std::bitset<6>("100100"), std::bitset<11>(UIMMEDIATE_OP), LOAD_UIMMEDIATE, LOAD_UIMMEDIATE_FORMAT},
    {"lhu", UIMMEDIATE, std::bitset<6>("100101"), std::bitset<11>(UIMMEDIATE_OP), LOAD_UIMMEDIATE, LOAD_UIMMEDIATE_FORMAT},
    {"sgeui", UIMMEDIATE, std::bitset<6>("111101"), std::bitset<11>(UIMMEDIATE_OP), GENERIC_UIMMEDIATE, GENERIC_UIMMEDIATE_FORMAT},
    {"sleui", UIMMEDIATE, std::bitset<6>("111100"), std::bitset<11>(UIMMEDIATE_OP), GENERIC_UIMMEDIATE, GENERIC_UIMMEDIATE_FORMAT},
    {"sltui", UIMMEDIATE, std::bitset<6>("111010"), std::bitset<11>(UIMMEDIATE_OP), GENERIC_UIMMEDIATE, GENERIC_UIMMEDIATE_FORMAT},
    {"sgtui", UIMMEDIATE, std::bitset<6>("111011"), std::bitset<11>(UIMMEDIATE_OP), GENERIC_UIMMEDIATE, GENERIC_UIMMEDIATE_FORMAT},
    {"bgeu", UIMMEDIATE, std::bitset<6>("101101"), std::bitset<11>(UIMMEDIATE_OP), GENERIC_UIMMEDIATE, GENERIC_UIMMEDIATE_FORMAT},
    {"bgtu", UIMMEDIATE, std::bitset<6>("101111"), std::bitset<11>(UIMMEDIATE_OP), GENERIC_UIMMEDIATE, GENERIC_UIMMEDIATE_FORMAT},
    {"bltu", UIMMEDIATE, std::bitset<6>("110001"), std::bitset<11>(UIMMEDIATE_OP), GENERIC_UIMMEDIATE, GENERIC_UIMMEDIATE_FORMAT},
    {"bleu", UIMMEDIATE, std::bitset<6>("110011"), std::bitset<11>(UIMMEDIATE_OP), GENERIC_UIMMEDIATE, GENERIC_UIMMEDIATE_FORMAT},
